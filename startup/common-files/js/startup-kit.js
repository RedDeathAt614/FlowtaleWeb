...
startupKit.uiKitHeader._inFixedMode = function(headerClass) {
    ...
    if ($(headerClass + ' .navbar').hasClass('navbar-fixed-top')) {
        ...
        var antiflicker = $('<div class="' + headerClass.slice(1) + '-startup-antiflicker header-antiflicker" style="opacity: 0.0001; position: fixed; z-index: 2; left: 0; top: 0; width: 100%; height: 79px; background-color: '+antiflickerColor+';" />');
        ...
        $(window).scroll(function() {
            ...
            $('.navbar .brand', header).css({
                'font-size' : 25 + ((25 - 25) * headerZoom),
                'padding-top' : 23 + ((23 - 23) * headerZoom)
            });
